...
const CategoryProducts = () => {
  const { allproduct } = useContext(StoreContext)
    ...
    // }, [allproduct]);
      ...
      const allSubCategories = [...new Set(productfiltered.map(p => p.sub_category).filter(Boolean))];
      ...
      const filteredProducts = productfiltered.filter(product => {
        ...
        const categoryMatch = !categoryFilter || product.sub_category === categoryFilter;
        const priceMatch = (() => {
