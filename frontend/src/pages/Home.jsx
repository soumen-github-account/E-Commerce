  ...
  return (
    <>
      ...
      <div
        ...
        className="w-[85vw] flex items-center mt-3 bg-white shadow-sm border-1 border-gray-300 py-1 px-4 rounded-md ml-5 cursor-pointer md:hidden"
      >
        ...
        <div className="grid md:grid-cols-11 grid-cols-4 md:gap-5 gap-4 mt-4">
          {catagoryData.map((item, index) => (
            <div
              key={index}
              onClick={() => {
                navigate(`/allCategory-produt/${item.name}`);
                scrollTo(0, 0);
              }}
            >
