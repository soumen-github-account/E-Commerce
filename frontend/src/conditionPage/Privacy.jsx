...
const Privacy = () => {
  return (
    <div className='w-full'>
        <HeaderSearch />
        <h1 className='text-[20px] font-bold font-sans ml-8'>Privacy & Policy</h1>
        <div className='font-sans w-full text-gray-800 px-8 flex items-center justify-center'>
      <p><span className='text-[15px] font-medium' >SDKING DEV</span> our operates the https://e-commerce-frontend-10m4.onrender.com website (the “Service”).
...
You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. The Help feature on most browsers provide information on how to accept cookies, disable cookies or to notify you when receiving a new cookie.<br/>If you do not accept cookies, you may not be able to use some features of our Service and we recommend that you leave them turned on.
...
<br/>
<span className='text-[15px] font-medium'>Behavioral Remarketing</span>
<br/>
<span className='text-[15px] font-medium' >SDKING DEV</span> uses remarketing services to advertise on third party web sites to you after you visited our Service. We, and our third party vendors, use cookies to inform, optimize and serve ads based on your past visits to our Service.
...
Only persons aged 13 or older have permission to access our Service. Our Service does not address anyone under the age of 13 (“Children”).

We do not knowingly collect personally identifiable information from children under 13. If you are a parent or guardian and you learn that your Children have provided us with Personal Information, please contact us. If we become aware that we have collected Personal Information from a children under age 13 without verification of parental consent, we take steps to remove that information from our servers.

Changes To This Privacy Policy

This Privacy Policy is effective as of November 01, 2018 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.
