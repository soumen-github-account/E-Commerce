...
const AllProduct = () => {
  const { allproduct, setAllproduct, totalProduct, setTotalProduct } =
      ...
      <div className="bg-white w-full p-4 rounded shadow-md">
        ...
        <div className="h-[33vw] overflow-scroll scroll-hide px-8">
          {filtered.map((item, index) => (
            <div
              key={index}
              className="flex justify-between items-center border-b-1 border-b-gray-500 py-2"
            >
              ...
              <div>
                <button
                  ...
                  className="bg-emerald-700 text-white px-4 py-1 cursor-pointer rounded-md"
                >
                  Edit
                </button>
                <button
                  onClick={() => deleteHandle(item._id)}
                  className="bg-red-500 text-white px-4 py-1 cursor-pointer ml-2 rounded-md"
                >
                  Delete
                </button>
              </div>
