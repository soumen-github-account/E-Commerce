    ...
    const fetchProduct = async () => {
      try {
        const { data } = await axios.get(
          `http://localhost:8000/api/product/products/${id}`,
        );
        setName(data.name);
        ...
        const catIndex = catagoryData.findIndex(
          (c) => c.name === data.categoryId,
        );
        setChange(catIndex);

        const subCatIndex = catagoryData[catIndex]?.subCategory?.findIndex(
          (s) => s.name === data.sub_category,
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `http://localhost:8000/api/product/product-edit/${id}`,
        formData,
      );
            ...
            <div className="flex gap-2">
              <label htmlFor="image1">
                <img
                  ...
                  src={
                    prodImg1
                      ? typeof prodImg1 === "string"
                        ? prodImg1
                        : URL.createObjectURL(prodImg1)
                      : upload_area
                  }
                  alt=""
                />
                <input
                  onChange={(e) => setProdImg1(e.target.files[0])}
                  type="file"
                  id="image1"
                  hidden
                />
              ...
              <label htmlFor="image2">
                <img
                  ...
                  src={
                    prodImg2
                      ? typeof prodImg2 === "string"
                        ? prodImg2
                        : URL.createObjectURL(prodImg2)
                      : upload_area
                  }
                  alt=""
                />
                <input
                  onChange={(e) => setProdImg2(e.target.files[0])}
                  type="file"
                  id="image2"
                  hidden
                />
              ...
              <label htmlFor="image3">
                <img
                  ...
                  src={
                    prodImg3
                      ? typeof prodImg3 === "string"
                        ? prodImg3
                        : URL.createObjectURL(prodImg3)
                      : upload_area
                  }
                  alt=""
                />
                <input
                  onChange={(e) => setProdImg3(e.target.files[0])}
                  type="file"
                  id="image3"
                  hidden
                />
              ...
              <label htmlFor="image4">
                <img
                  ...
                  src={
                    prodImg4
                      ? typeof prodImg4 === "string"
                        ? prodImg4
                        : URL.createObjectURL(prodImg4)
                      : upload_area
                  }
                  alt=""
                />
                <input
                  onChange={(e) => setProdImg4(e.target.files[0])}
                  type="file"
                  id="image4"
                  hidden
                />
            ...
            <div className="w-full lg:flex-1 flex flex-col gap-4">
              ...
              <div className="flex w-full flex-wrap gap-x-4 gap-y-1 border-1 rounded-md border-gray-300 px-2 py-2">
                {catagoryData.map((item, index) => (
                  <div
                    onClick={() => categoryChoose(index)}
                    key={index}
                    className={`flex items-center justify-center flex-col text-sm cursor-pointer`}
                  >
                    <img
                      src={item.img}
                      className={`rounded-full w-20 ${category === item.name ? "border-2 border-red-700" : ""}`}
                      alt=""
                    />
                    <p>{item.name}</p>
                  </div>
              ...
              <div className="flex w-full flex-wrap gap-x-4 gap-y-1 border-1 rounded-md border-gray-300 px-2 py-2">
                {catagoryData[change].subCategory.map((item, index) => (
                  <div
                    onClick={() => subcategoryChoose(item.name, index)}
                    key={index}
                    className={`flex items-center justify-center flex-col text-sm cursor-pointer`}
                  >
                    <img
                      src={item.img}
                      className={`rounded-full w-20 ${subCategory === item.name ? "border-2 border-red-700" : ""}`}
                      alt=""
                    />
                    <p>{item.name}</p>
                  </div>
              ...
              <div className="flex w-full flex-wrap gap-x-4 gap-y-1 border-1 rounded-md border-gray-300 px-2 py-2">
                {catagoryData[change]?.subCategory[change2]?.subCatagory2?.map(
                  (item, index) => (
                    <div
                      onClick={() => setSubCategory2(item.name)}
                      key={index}
                      className={`flex items-center justify-center flex-col text-sm cursor-pointer`}
                    >
                      <img
                        src={item.img}
                        className={`rounded-full w-20 ${subCategory2 === item.name ? "border-2 border-red-700" : ""}`}
                        alt=""
                      />
                      <p>{item.name}</p>
                    </div>
              ...
              <div className="flex-1 flex flex-col gap-1">
                ...
                <input
                  ...
                  className="border rounded px-3 py-2"
                  type="number"
                  placeholder="Enter nmber of stock product"
                  required
                />
              </div>
            </div>
              ...
              {brands.map((item, index) => (
                <div key={index} className="flex gap-4 items-center mb-3">
                  <input
                    ...
                    value={item.type}
                    onChange={(e) =>
                      handleChangeBrand(index, "type", e.target.value)
                    }
                    className="w-1/2 p-2 border border-gray-300 rounded"
                  />
                  <input
                    ...
                    onChange={(e) =>
                      handleChangeBrand(index, "description", e.target.value)
                    }
                    className="w-1/2 p-2 border border-gray-300 rounded"
                  />
                  <button
