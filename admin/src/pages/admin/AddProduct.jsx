...
const AddProduct = () => {
  ...
  // useEffect(() => {
  // const filtered = catagoryData[change].subCategory[change2].filter(product => product.sub_category2 === subCategory2);
        ...
        <div>
          ...
          <div className="flex gap-2">
            <label htmlFor="image1">
              <img
                className="w-17 h-17"
                src={prodImg1 ? URL.createObjectURL(prodImg1) : upload_area}
                alt=""
              />
              <input
            ...
            <label htmlFor="image2">
              <img
                className="w-17 h-17"
                src={prodImg2 ? URL.createObjectURL(prodImg2) : upload_area}
                alt=""
              />
              <input
            ...
            <label htmlFor="image3">
              <img
                className="w-17 h-17"
                src={prodImg3 ? URL.createObjectURL(prodImg3) : upload_area}
                alt=""
              />
              <input
            ...
            <label htmlFor="image4">
              <img
                className="w-17 h-17"
                src={prodImg4 ? URL.createObjectURL(prodImg4) : upload_area}
                alt=""
              />
              <input
